            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            <label for="bloodgrp" class="col-md-4 col-form-label text-md-right">{{ __('Blood Group') }}</label>

                            <div class="col-md-6">
                                <select id="bloodgrp" class="form-control{{ $errors->has('bloodgrp') ? ' is-invalid' : '' }}" name="bloodgrp" required >
                                ...
                                @if ($errors->has('bloodgrp'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('bloodgrp') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
